        ...
        <div className="bg-white/90 backdrop-blur-md rounded-3xl shadow-xl p-8 md:p-12">
          ...
          <div className="prose prose-violet max-w-none font-['Poppins']">
            <p className="text-lg text-gray-700 mb-6">
              Welcome to SmartPet, where our passion for pets drives everything we do. Founded in 2023, SmartPet was born from a simple idea: to create a loving community where pet owners, animal lovers, and furry friends can connect, share, and grow together.
            </p>
            ...
            <div className="space-y-6 mb-10">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">We believe in the power of community. SmartPet connects you with fellow pet lovers who share your passion, challenges, and joys of pet parenthood.</p>
                </div>
              </div>
